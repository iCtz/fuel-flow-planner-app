...
const Index = () => {
  ...
  return (
    <DashboardLayout 
      ...
      actions={
        <Button variant="default" size="sm" onClick={handleAddPlan}>
      ...
      <div className="space-y-6">
        ...
        {currentPlans.length > 0 ? (
            ...
            <TabsContent value="overview" className="mt-6 space-y-6">
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {currentPlans.map(plan => {
                  const zone = allZones.find(z => z.id === plan.zoneId);
          ...
          <div className="bg-card border rounded-lg p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              ...
              {selectedZone === 'all' ? 
                t("planning.anyZone") : 
                renderLocalizedString(allZones.find(z => z.id === selectedZone)?.name || t("common.unknownZone"))
        ...
        <Tabs defaultValue="generators" className="mt-8">
          ...
          <TabsContent value="generators">
            <GeneratorsTab generators={allGenerators} />
          </TabsContent>
          
          <TabsContent value="sites">
            <SitesTab sites={allSites} zones={allZones} />
          </TabsContent>
          
          <TabsContent value="regions">
            <RegionsZonesTab regions={regions} zones={allZones} />
          </TabsContent>
